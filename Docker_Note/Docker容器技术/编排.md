...
![image-20220703163126221](https://image.itbaima.cn/markdown/2022/07/03/5XDiAMpgW9aqUGJ.png)
...
![image-20220703175103531](https://image.itbaima.cn/markdown/2022/07/03/GmcqXEV3tsPQYd9.png)
...
![image-20220703180206437](https://image.itbaima.cn/markdown/2022/07/03/M1gcJFUfQtnEpmB.png)
...
![image-20220703182541976](https://image.itbaima.cn/markdown/2022/07/03/bTWZkQidsqfNc9w.png)

![image-20220703182559020](https://image.itbaima.cn/markdown/2022/07/03/YHzOEhS5giBVql2.png)

看到 Running 4/4 就表示已经部署成功了，我们现在到服务器这边来看看情况：

![image-20220703182657205](https://image.itbaima.cn/markdown/2022/07/03/ZAsg3KM8r19malT.png)

可以看到，这里确实是按照我们的配置，创建了3个容器，并且都是处于运行中，可以正常访问：

![image-20220703182958392](https://image.itbaima.cn/markdown/2022/07/03/GqbV1SWMRY8jnEc.png)

如果想要结束的话，我们只需要点击停止就行了：

![image-20220703183240400](https://image.itbaima.cn/markdown/2022/07/03/ZNRB1XegVFJEaQ7.png)

当然如果我们不再需要这套环境的话，可以直接点击下方的按钮，将整套编排给down掉，这样的话相对应的容器也会被清理的：

![image-20220703183730693](https://image.itbaima.cn/markdown/2022/07/03/IOVsb3tGpqAnHk9.png)

![image-20220703183807157](https://image.itbaima.cn/markdown/2022/07/03/ZWbxDKTCimdo6Mr.png)

注意在使用docker-compose部署时，会自动创建一个新的自定义网络，并且所有的容器都是连接到这个自定义的网络里面：

![image-20220703210431690](https://image.itbaima.cn/markdown/2022/07/03/NB2MfgA5GZuCSnd.png)

这个网络默认也是使用bridge作为驱动：

![image-20220703210531073](https://image.itbaima.cn/markdown/2022/07/03/jEazItdPKxuRcCQ.png)
...
![image-20220703215050497](https://image.itbaima.cn/markdown/2022/07/03/frdTCPDGIuqwAWH.png)

现在我们重新部署docker-compos吧：

![image-20220703215133786](https://image.itbaima.cn/markdown/2022/07/03/Tjq8ZYiU4FewKHE.png)

当三个服务全部为蓝色时，就表示已经正常运行了，现在我们来测试一下吧：

![image-20220703215211999](https://image.itbaima.cn/markdown/2022/07/03/3TYABoDZGpK6Rjb.png)

接着我们来试试看向数据库传入数据：

![image-20220703215236719](https://image.itbaima.cn/markdown/2022/07/03/nVEURiAe7qjworl.png)

![image-20220703215245757](https://image.itbaima.cn/markdown/2022/07/03/QKFDdriwJCgPbxW.png)

可以看到响应成功，接着我们来请求一下：

![image-20220703215329690](https://image.itbaima.cn/markdown/2022/07/03/uB6rYDCSbLXmOPE.png)
...
![image-20220703220941562](https://image.itbaima.cn/markdown/2022/07/03/2O9ExC4YgrJsjfe.png)

![image-20220703221002195](https://image.itbaima.cn/markdown/2022/07/03/1SRG8EDtx5Oqr2M.png)
